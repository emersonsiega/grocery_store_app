...
class _FakeRouteData_6 extends _i1.Fake implements _i5.RouteData {}

class _FakeNavigationHistory_7 extends _i1.Fake
    implements _i5.NavigationHistory {}

class _FakeStackRouter_8 extends _i1.Fake implements _i5.StackRouter {}

class _FakeRouteMatch_9<T> extends _i1.Fake implements _i5.RouteMatch<T> {}
...
class MockStackRouter extends _i1.Mock implements _i5.StackRouter {
  ...
  _i5.PageBuilder get pageBuilder => (super.noSuchMethod(
          ...
          returnValue: (_i5.RouteData data) => _FakeAutoRoutePage_4<dynamic>())
      as _i5.PageBuilder);
  @override
  ...
  _i5.RouteData get current => (super.noSuchMethod(Invocation.getter(#current),
      returnValue: _FakeRouteData_6()) as _i5.RouteData);
  @override
  ...
  bool get hasEntries =>
      (super.noSuchMethod(Invocation.getter(#hasEntries), returnValue: false)
          as bool);
  @override
  Map<_i2.LocalKey, _i5.RoutingController> get childControllers =>
      (super.noSuchMethod(Invocation.getter(#childControllers),
              returnValue: <_i2.LocalKey, _i5.RoutingController>{})
          as Map<_i2.LocalKey, _i5.RoutingController>);
  @override
  _i5.NavigationHistory get navigationHistory =>
      (super.noSuchMethod(Invocation.getter(#navigationHistory),
          returnValue: _FakeNavigationHistory_7()) as _i5.NavigationHistory);
  @override
  ...
  _i5.StackRouter get root => (super.noSuchMethod(Invocation.getter(#root),
      returnValue: _FakeStackRouter_8()) as _i5.StackRouter);
  @override
  bool get isRoot =>
  ...
  _i5.RouteMatch<dynamic> get topMatch => (super.noSuchMethod(
      ...
      returnValue: _FakeRouteMatch_9<dynamic>()) as _i5.RouteMatch<dynamic>);
  @override
  ...
  @override
  _i6.Future<T?> pushWidget<T extends Object?>(_i2.Widget? widget,
  ...
  @override
  _i6.Future<T?> pushNativeRoute<T extends Object?>(_i2.Route<T>? route) =>
  ...
  _i5.RoutingController topMostRouter({bool? ignorePagelessRoutes = false}) =>
      (super.noSuchMethod(
          ...
          returnValue: _FakeRoutingController_10()) as _i5.RoutingController);
  @override
  _i6.Future<bool> pop<T extends Object?>([T? result]) =>
  ...
  void removeRoute(_i5.RouteData? route, {bool? notify = true}) => super
      .noSuchMethod(Invocation.method(#removeRoute, [route], {#notify: notify}),
          returnValueForMissingStub: null);
  @override
  _i6.Future<T?> push<T extends Object?>(_i5.PageRouteInfo<dynamic>? route,
          {_i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
          Invocation.method(#push, [route], {#onFailure: onFailure}),
          returnValue: Future<T?>.value()) as _i6.Future<T?>);
  @override
  _i6.Future<T?> replace<T extends Object?>(_i5.PageRouteInfo<dynamic>? route,
          {_i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
          Invocation.method(#replace, [route], {#onFailure: onFailure}),
          returnValue: Future<T?>.value()) as _i6.Future<T?>);
  @override
  _i6.Future<void> pushAll(List<_i5.PageRouteInfo<dynamic>>? routes,
          {_i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> popAndPushAll(List<_i5.PageRouteInfo<dynamic>>? routes,
          {dynamic onFailure}) =>
      (super.noSuchMethod(
          ...
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> replaceAll(List<_i5.PageRouteInfo<dynamic>>? routes,
          {_i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
  ...
  void popUntilRoot() =>
      super.noSuchMethod(Invocation.method(#popUntilRoot, []),
          returnValueForMissingStub: null);
  @override
  _i6.Future<T?> popAndPush<T extends Object?, TO extends Object?>(
  ...
  void popUntil(_i2.RoutePredicate? predicate) =>
      super.noSuchMethod(Invocation.method(#popUntil, [predicate]),
          returnValueForMissingStub: null);
  @override
  bool removeWhere(_i5.RouteDataPredicate? predicate) =>
  ...
  void updateDeclarativeRoutes(List<_i5.PageRouteInfo<dynamic>>? routes) =>
      super.noSuchMethod(Invocation.method(#updateDeclarativeRoutes, [routes]),
          returnValueForMissingStub: null);
  @override
  _i6.Future<void> navigateAll(List<_i5.RouteMatch<dynamic>>? routes,
          {_i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
          ...
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<T?> pushAndPopUntil<T extends Object?>(
          _i5.PageRouteInfo<dynamic>? route,
      ...
      (super.noSuchMethod(
          ...
          returnValue: Future<T?>.value()) as _i6.Future<T?>);
  @override
  _i6.Future<T?> replaceNamed<T extends Object?>(String? path,
      ...
      (super.noSuchMethod(
          ...
          returnValue: Future<T?>.value()) as _i6.Future<T?>);
  @override
  _i6.Future<T?> pushNamed<T extends Object?>(String? path,
          {bool? includePrefixMatches = false,
          _i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
